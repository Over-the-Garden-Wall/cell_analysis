function [fig_handle dist cont_area] = plot_cell_contact_by_distance(contacting_cells, target_cells, use_axis, use_arbor, normalize_by_SA, colors, fig_handle)
    ...
    for n = 1:length(target_cells);
        scatter(get(fig_handle, 'CurrentAxes'), dist(:,n), cont_area(:,n), 'o', 'MarkerFaceColor', colors(n,:), 'MarkerEdgeColor', colors(n,:));
    end
end