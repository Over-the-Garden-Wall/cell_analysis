...
[quartile_data bins full_x full_data] = get_stratification_by_dist(cell_nums, [], bins, [.25 .5 .75], true, true);

plot(bins, sum(full_data), 'LineWidth', 2);
...
% % end
% 
% plot(bins, overlap(:,5)./overlap(:,2), 'LineWidth', 2);
% % legend(types(2:end));
