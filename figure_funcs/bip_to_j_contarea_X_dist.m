...
warning('changed the nes ttwo lines, undo later')
cell_nums{1} = [C.type.t1] %C.type.t2];
cell_nums{2} = [C.type.t2] %C.type.t2];
cell_nums{3} = [C.type.A2] %C.type.t2];


% cell_nums{2} = [C.type.t4] %C.type.t3a C.type.t3b C.type.t4];
