function q = polar_scatter(varargin)
...
%     q = scatter(xx,yy,'parent',cax);
% else
%     q = scatter(xx,yy,line_style,'parent',cax);
% end
q = scatter(xx,yy,varargin{3:end});
...
if ~isempty(q) && ~isdeployed
    makemcode('RegisterHandle',cax,'IgnoreHandle',q,'FunctionName','polar_scatter');
end